...
public class lista_amigos extends Activity {
    ...
    ListView ltsAmigos;
    Cursor cAmigos;
    final ArrayList<amigo> alAmigos = new ArrayList<>();
    final ArrayList<amigo> alAmigosCopia = new ArrayList<>();
    JSONArray jsonArray;
            ...
            confirmacion.setPositiveButton("SI", (dialog, which) -> {
                try {
                    ...
                    if (respuesta.equals("ok")) {
                        obtenerAmigos();
                        mostrarMsg("Amigo borrado con éxito.");
                    }
                } catch (Exception e) {
    ...
    private void obtenerAmigos() {
        try {
            ...
            if (cAmigos != null && cAmigos.moveToFirst()) {
